...
export default function CollectionCrossSell({ others }: { others: Collection[] }) {
          ...
          {others.map((c) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-7">
                {c.tagline && <span className="font-body text-[10px] tracking-[0.15em] text-sage uppercase">{c.tagline}</span>}
