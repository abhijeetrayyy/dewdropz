...
const s = StyleSheet.create({
  ...
  // FlatList's columnWrapperStyle replaces the old flex-wrap grid: the row is
  // what gets the gutter and the spacing now, and the cell just claims its half.
  row: { paddingHorizontal: S.gutter, justifyContent: "space-between", marginTop: S.xl },
  cell: { width: "48%" },
});
